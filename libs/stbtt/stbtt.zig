...
pub const bakeFontBitmap = @extern(*const fn (data: [*]const u8, offset: i32, pixel_height: f32, pixels: [*]u8, pw: i32, ph: i32, first_char: i32, num_chars: i32, chardata: [*]BakedChar) callconv(.c) BigBool, .{ .name = "stbtt_BakeFontBitmap" });
...
pub const packBegin = @extern(*const fn (spc: *PackContext, pixels: [*]u8, width: i32, height: i32, stride_in_bytes: i32, padding: i32, alloc_context: ?*anyopaque) callconv(.c) BigBool, .{ .name = "stbtt_PackBegin" });
pub const packEnd = @extern(*const fn (spc: *PackContext) callconv(.c) void, .{ .name = "stbtt_PackEnd" });
pub const packFontRange = @extern(*const fn (spc: *PackContext, fontdata: [*]const u8, font_index: i32, font_size: f32, first_unicode_char_in_range: i32, num_chars_in_range: i32, chardata_for_range: [*]PackedChar) callconv(.c) BigBool, .{ .name = "stbtt_PackFontRange" });
pub const packFontRanges = @extern(*const fn (spc: *PackContext, fontdata: [*]const u8, font_index: i32, ranges: [*]const PackRange, num_ranges: i32) callconv(.c) BigBool, .{ .name = "stbtt_PackFontRanges" });
...
pub const packFontRangesGatherRects = @extern(*const fn (spc: *PackContext, info: *const FontInfo, ranges: [*]PackRange, num_ranges: i32, rects: [*]Rect) callconv(.c) BigBool, .{ .name = "stbtt_PackFontRangesGatherRects" });
...
pub const packFontRangesRenderIntoRects = @extern(*const fn (spc: *PackContext, info: *const FontInfo, ranges: [*]const PackRange, num_ranges: i32, rects: [*]Rect) callconv(.c) BigBool, .{ .name = "stbtt_PackFontRangesRenderIntoRects" });
pub const getNumberOfFonts = @extern(*const fn (data: [*]const u8) callconv(.c) BigBool, .{ .name = "stbtt_GetNumberOfFonts" });
pub const getFontOffsetForIndex = @extern(*const fn (data: [*]const u8, index: i32) callconv(.c) BigBool, .{ .name = "stbtt_GetFontOffsetForIndex" });
pub const initFont = @extern(*const fn (info: *FontInfo, data: [*]const u8, offset: i32) callconv(.c) BigBool, .{ .name = "stbtt_InitFont" });
pub const findGlyphIndex = @extern(*const fn (info: *const FontInfo, unicode_codepoint: i32) callconv(.c) BigBool, .{ .name = "stbtt_FindGlyphIndex" });
...
pub const getFontVMetricsOS2 = @extern(*const fn (info: *const FontInfo, typoAscent: ?*i32, typoDescent: ?*i32, typoLineGap: ?*i32) callconv(.c) BigBool, .{ .name = "stbtt_GetFontVMetricsOS2" });
...
pub const getCodepointBox = @extern(*const fn (info: *const FontInfo, codepoint: i32, x0: ?*i32, y0: ?*i32, x1: ?*i32, y1: ?*i32) callconv(.c) BigBool, .{ .name = "stbtt_GetCodepointBox" });
...
pub const getGlyphKernAdvance = @extern(*const fn (info: *const FontInfo, glyph1: i32, glyph2: i32) callconv(.c) BigBool, .{ .name = "stbtt_GetGlyphKernAdvance" });
pub const getGlyphBox = @extern(*const fn (info: *const FontInfo, glyph_index: i32, x0: ?*i32, y0: ?*i32, x1: ?*i32, y1: ?*i32) callconv(.c) BigBool, .{ .name = "stbtt_GetGlyphBox" });
pub const getKerningTableLength = @extern(*const fn (info: *const FontInfo) callconv(.c) i32, .{ .name = "stbtt_GetKerningTableLength" });
pub const getKerningTable = @extern(*const fn (info: *const FontInfo, table: [*]KerningEntry, table_length: i32) callconv(.c) BigBool, .{ .name = "stbtt_GetKerningTable" });
pub const isGlyphEmpty = @extern(*const fn (info: *const FontInfo, glyph_index: i32) callconv(.c) BigBool, .{ .name = "stbtt_IsGlyphEmpty" });
pub const getCodepointShape = @extern(*const fn (info: *const FontInfo, unicode_codepoint: i32, vertices: *[*]Vertex) callconv(.c) BigBool, .{ .name = "stbtt_GetCodepointShape" });
pub const getGlyphShape = @extern(*const fn (info: *const FontInfo, glyph_index: i32, vertices: *[*]Vertex) callconv(.c) BigBool, .{ .name = "stbtt_GetGlyphShape" });
...
pub const getCodepointSVG = @extern(*const fn (info: *const FontInfo, unicode_codepoint: i32, svg: *[*]const u8) callconv(.c) BigBool, .{ .name = "stbtt_GetCodepointSVG" });
pub const getGlyphSVG = @extern(*const fn (info: *const FontInfo, gl: i32, svg: *[*]const u8) callconv(.c) BigBool, .{ .name = "stbtt_GetGlyphSVG" });
...
pub const findMatchingFont = @extern(*const fn (fontdata: [*]const u8, name: [*:0]const u8, flags: i32) callconv(.c) BigBool, .{ .name = "stbtt_FindMatchingFont" });
pub const compareUTF8toUTF16_bigendian = @extern(*const fn (s1: [*]const u8, len1: i32, s2: [*]const u8, len2: i32) callconv(.c) BigBool, .{ .name = "stbtt_CompareUTF8toUTF16_bigendian" });
