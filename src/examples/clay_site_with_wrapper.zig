...
test {
    log.debug("semantic analysis for examples/clay_site_with_wrapper.zig", .{});
...
const COLORS_TOP_BORDER = [_]Ui.Color{
    .fromLinearU8(240, 213, 137, 255),
    .fromLinearU8(236, 189, 80, 255),
    .fromLinearU8(225, 138, 50, 255),
    .fromLinearU8(223, 110, 44, 255),
    .fromLinearU8(168, 66, 28, 255),
};

const COLOR_BLOB_BORDER_1 = Ui.Color.fromLinearU8(168, 66, 28, 255);
const COLOR_BLOB_BORDER_2 = Ui.Color.fromLinearU8(203, 100, 44, 255);
const COLOR_BLOB_BORDER_3 = Ui.Color.fromLinearU8(225, 138, 50, 255);
const COLOR_BLOB_BORDER_4 = Ui.Color.fromLinearU8(236, 159, 70, 255);
const COLOR_BLOB_BORDER_5 = Ui.Color.fromLinearU8(240, 189, 100, 255);
...
pub fn main() !void {
    ...
    // Init Ui
    var ui = try Ui.init(gpa, arena_state.allocator(), demo.renderer, &asset_cache, &bindings);
    defer ui.deinit();
